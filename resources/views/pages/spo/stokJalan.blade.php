                    ...
                    <form action="/spo/request_barang" method="post" class="myForm" enctype="multipart/form-data"
                        ...
                        <div class="modal-body">
                            ...
                            <div>
                                ...
                                <input type="number" name="produk[]" placeholder="B16" class="form-control" value="0"
                                    min="0"><br>
                            ...
                            <div>
                                ...
                                <input type="number" name="produk[]" placeholder="B12" class="form-control" value="0"
                                    min="0"><br>
                            ...
                            <div>
                                ...
                                <input type="number" name="produk[]" placeholder="R16" class="form-control" value="0"
                                    min="0"><br>
    ...
    <div class="modal fade" id="modalCekBarang" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <form class="modal-content" action="/spo/terima_barang" method="post">
                @csrf
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Penerimaan Barang</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
