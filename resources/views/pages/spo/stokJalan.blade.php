...
@section('spo.body')
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Request Stok</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="/spo/request_barang" method="post" class="myForm" enctype="multipart/form-data"
                        id="formToko">
                        @csrf
                        <div class="modal-body">
                            <div>
                                <label for="b20" class="form-label">GROW BOLD 20</label>
                                <input type="number" id="B20" name="jumlah[]" placeholder="B20" class="form-control"
                                    value="0" min="0"><br>
                            ...
                            <div>
                                ...
                                <input type="number" name="jumlah[]" placeholder="B16" class="form-control" value="0"
                                    min="0"><br>
                            ...
                            <div>
                                ...
                                <input type="number" name="jumlah[]" placeholder="B12" class="form-control" value="0"
                                    min="0"><br>
                            ...
                            <div>
                                ...
                                <input type="number" name="jumlah[]" placeholder="R16" class="form-control" value="0"
                                    min="0"><br>
                            ...
                            <div>
                                ...
                                <input type="number" name="jumlah[]" placeholder="R12" class="form-control"
                                    value="0" min="0"><br>
                            ...
                            <div>
                                ...
                                <input type="number" name="jumlah[]" placeholder="KK" class="form-control"
                                    value="0" min="0"><br>
                            ...
                            <div>
                                ...
                                <input type="number" name="jumlah[]" placeholder="KC" class="form-control"
                                    value="0" min="0"><br>
                            ...
                            <div>
                                ...
                                <input type="number" name="jumlah[]" placeholder="BB16" class="form-control"
                                    value="0" min="0"><br>
                            ...
                            <div>
                                ...
                                <input type="number" name="jumlah[]" placeholder="BB12" class="form-control"
                                    value="0" min="0"><br>
                            ...
                            {{-- <div>
                                ...
                                <input type="number" name="jumlah[]" placeholder="BICE16" class="form-control"
                                    value="0" min="0"><br>
    ...
    <div class="modal fade" id="modalCekBarang" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <form class="modal-content" action="/spo/terima_barang" method="post">
                @csrf
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($barangKonfirmasi as $brg)
                        <div>
                            ...
                            <input min="0" type="number" placeholder="" class="form-control"
                                value="{{ $brg->jumlah }}" disabled><br>
                ...
                <div class="modal-footer">
                    <button type="submit" name="batal" class="btn btn-danger"
                        onclick="return confirm('Yakin tidak ingin menerima barang?')">Batal</button>
                    <button type="submit" name="setuju" class="btn btn-success"
                        onclick="return confirm('Terima barang?')">Setuju</button>
                </div>
            </form>
        </div>
    </div>
