...
@section('headAcc.body')
    <main>
        <a href="/headAcc/request_gudang_kecil" class="btn btn-outline-secondary mb-2">
        ...
        <div class="mt-4">
			<form action="{{ $user[0]->id }}/konfirmasi" method="post" onsubmit="return confirm('Konfirmasi Request Admin2?')">
                ...
                <input type="text" name="catatan" 
                                class="form-control" style="width: 250px;" placeholder="catatan konfirmasi" required><br>
